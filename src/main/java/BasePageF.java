...
public class BasePageF {
    ...
    //BASE PAGE CHROME
    public BasePageF(FirefoxDriver driver) {
        this.driver = driver;
    ...
    public void addtoFavMreze() {
        waitForElement(addToFavMreze);
        addToFavMreze.click();
    }

    public void addToFavRat() {
        addToFavRat.click();
        waitForElementToBeClickable(favSve);
        favSve.click();
    }
    //REMOVE FROM FAV
    ...
    public void fullPregled() {
        ...
        waitForElementToBeClickable(bookSpecIzSVEE);
    ...
    public void openAndCloseTwitterPage() {
        ...
        ArrayList<String> tabs = new ArrayList<>(driver.getWindowHandles());
        driver.switchTo().window(tabs.get(1));
        driver.navigate().to(Strings.TWITTER_URL);
    ...
    public void openAndCloseInstagramPage() {
        ...
        driver.navigate().to(Strings.INSTA_URL);
        String actualUrl =driver.getCurrentUrl();
    ...
    public void openAndCloseTikTokPage() {
        ...
        driver.navigate().to(Strings.TIK_TOK_URL);
        String actualUrl = driver.getCurrentUrl();
