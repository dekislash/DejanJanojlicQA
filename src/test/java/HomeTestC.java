...
public class HomeTestC extends BaseTestC {
    ...
    public void qaTests() {
        ...
        try {
            ...
            BasePageC qaPage = new BasePageC(driver);
    ...
    public void chatTests() {
        ChromeDriver driver = openChromeDriver();
        try {
            BasePageC chatPage = new BasePageC(driver);
    ...
    public void newsLetTest() {
        ChromeDriver driver = openChromeDriver();
        try {
            BasePageC newsPage = new BasePageC(driver);
    ...
    public void linksTestsHomeFoot() {
        ...
        try {
            print("Go to: 'https://www.knjizare-vulkan.rs/'");
            BasePageC basePage = new BasePageC(driver);
    ...
    public void connectToSocialNetworks() {
        ...
        try {
            print("Go to: 'https://www.knjizare-vulkan.rs/.");
            BasePageC socialPage = new BasePageC(driver);
